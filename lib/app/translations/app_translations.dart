...
/// All EN/BN copy, resolved in UI via 'key'.tr.
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'landing_description': 'Mobile-based online information form',
      ...
      'step1_not_found': 'Mobile number not found',
      'step1_already_submitted': 'Your data is already submitted',
      'step1_check_failed':
          'Unable to verify submission status. Please try again.',
      ...
      // Validation
      'val_roll_required': 'Mobile number is required',
    ...
    'bn_BD': {
      ...
      'landing_button': 'Submit Information / তথ্য জমা দিন',
      'landing_description': 'মোবাইল-ভিত্তিক অনলাইন তথ্য ফর্ম',
      ...
      'step1_check_failed':
          'সাবমিশন যাচাই করা যায়নি। অনুগ্রহ করে আবার চেষ্টা করুন।',
      ...
      'step4_subtitle':
          'নিচের বক্সগুলোতে সতর্কভাবে আপনার এসএসসি পরীক্ষার তথ্য দিন',
      ...
      'step6_confirm_message':
          'আপনি কি জমা দিতে চান? জমা দেওয়ার আগে আপনার তথ্য পর্যালোচনা করুন।',
      ...
      'success_home_button': 'হোম পেজে যান / Back to Home',

      // Validation
      'val_roll_required': 'মোবাইল নম্বর আবশ্যক',
